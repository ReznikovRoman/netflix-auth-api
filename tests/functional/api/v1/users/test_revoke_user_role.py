...
class TestRevokeUserRole(Auth0AccessTokenMixin):
    ...
    def test_ok(self, anon_client, role_dto, user_dto):
        ...
        anon_client.delete(url, headers=headers)

    def test_no_role_after_delete(self, anon_client, role_dto, user_dto):
    ...
    def test_role_does_not_exist(self, anon_client, user_dto):
        ...
        anon_client.delete(f"/api/v1/users/{user_id}/roles/XXX", headers=headers, expected_status_code=404)
    ...
    def test_user_does_not_exist(self, anon_client, role_dto):
        ...
        anon_client.delete(f"/api/v1/users/XXX/roles/{role_id}", headers=headers, expected_status_code=404)
    ...
    def test_invalid_access_token(self, anon_client, role_dto, user_dto):
        ...
        anon_client.delete(f"/api/v1/users/{user_id}/roles/{role_id}", headers=headers, expected_status_code=401)
    ...
    def test_no_credentials(self, anon_client, role_dto, user_dto):
        ...
        anon_client.delete(f"/api/v1/users/{user_id}/roles/{role_id}", expected_status_code=401)
