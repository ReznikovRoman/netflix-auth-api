...
class TestRevokeUserRole(
    ...
    def test_no_role_after_delete(self, _user_role):
        ...
        self.client.head(url, headers=headers, expected_status_code=404)
    ...
    def test_role_does_not_exist(self, user_dto):
        ...
        self.client.delete(f"/api/v1/users/{user_id}/roles/XXX", headers=headers, expected_status_code=404)
    ...
    def test_user_does_not_exist(self, role_dto):
        ...
        self.client.delete(f"/api/v1/users/XXX/roles/{role_id}", headers=headers, expected_status_code=404)
